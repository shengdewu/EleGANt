...
def color_transfer(source, target, clip=True, preserve_paper=False, is_style=True):
    """
    ...
    l_mean_tar, l_std_tar = l.mean(), l.std()
    a_mean_tar, a_std_tar = a.mean(), a.std()
    b_mean_tar, b_std_tar = b.mean(), b.std()
